...
RESULTS_PATH = '/media/gohu/backup_data/postdoc/gangstr_predicates_instructions/output_learner/job_SIGNIFICANT_goal_pred_sqil_demos7_exp3_500_demos/'
SAVE_PATH = '/media/gohu/backup_data/postdoc/gangstr_predicates_instructions/output_learner/job_SIGNIFICANT_goal_pred_sqil_demos7_exp3_500_demos/plots_results/'
...
if __name__ == '__main__':
    ...
    for PLOT in TO_PLOT:
        ...
        conditions = ['naive_literal', 'naive_pragmatic', 'pedagogical_literal', 'pedagogical_pragmatic']
        labels = ['Naive  + Literal ', 'Naive  + Pragmatic ', 'Pedagogical  + Literal ', 'Pedagogical  + Pragmatic ' ]
